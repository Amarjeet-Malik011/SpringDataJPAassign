...
import com.ttn.springDataJPApractise.entity.Person;
import com.ttn.springDataJPApractise.repository.PersonRepository;
...
public class Application {
	public static void main(String[] arg){
		...
		//Quetsion 8Get complete information of the Person whose age is 25 using @Query.
